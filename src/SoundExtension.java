...
public class SoundExtension extends org.nlogo.api.DefaultClassManager
{
    ...
    **/
        ...
        throws org.nlogo.api.ExtensionException
    {
        try {
            ...
            for(javax.sound.midi.MidiChannel ch: channels){ ch.programChange(0); }
    ...
    **/
    ...
    {
		if ( currentClip != null )
		{ currentClip.stop() ; currentClip = null ; }
	}
    ...
    * @throws org.nlogo.api.ExtensionException if the instrument does not exist
    **/
